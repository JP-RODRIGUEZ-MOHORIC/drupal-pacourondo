...
class __TwigTemplate_50c1543b85aeddb4733120707efe86ff extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if link -%}
  {{ link }}
{%- endif %}
", "modules/contrib/token/templates/token-tree-link.html.twig", "/var/www/html/modules/contrib/token/templates/token-tree-link.html.twig");
    }
